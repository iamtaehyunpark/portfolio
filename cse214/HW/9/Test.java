 ...
 * Name: Taehyun Park
 * SBUID: 115242740
 * TODO: Fill in the class Test. You are free to add any imports from Java
 * Collections.
 * (as long as we learned about it in class)
 */

public class Test<E> implements Connectable<E> {
...
/*
		 System.out.println(Test.addEdge(0, 1, 1.0));
		 System.out.println(Test.addEdge(1, 2, 2.0));
		 System.out.println(Test.addEdge(2, 3, 3.0));
		 System.out.println(Test.addEdge(3, 4, 4.0));
		 System.out.println(Test.addEdge(4, 5, 1.0));
		 System.out.println(Test.addEdge(5, 6, 2.0));
		 System.out.println(Test.addEdge(6, 7, 3.0));
		 System.out.println(Test.addEdge(7, 8, 4.0));
		 System.out.println(Test.addEdge(8, 9, 1.0));
		 System.out.println(Test.addEdge(9, 10, 2.0));

*/
		System.out.println(Test.addEdge(0, 1, 1.0));
		System.out.println(Test.addEdge(1, 2, 2.0));
		System.out.println(Test.addEdge(0, 2, 3.0));
		System.out.println(Test.addEdge(2, 3, 4.0));
		System.out.println(Test.addEdge(0, 4, 1.0));
		System.out.println(Test.addEdge(2, 8, 2.0));
		System.out.println(Test.addEdge(3, 8, 3.0));
		System.out.println(Test.addEdge(7, 5, 4.0));
		System.out.println(Test.addEdge(5, 6, 1.0));
		System.out.println(Test.addEdge(1, 5, 2.0));
		System.out.println(Test.addEdge(7, 6, 2.0));
		System.out.println(Test.addEdge(4, 10, 2.0));
		System.out.println(Test.addEdge(4, 9, 2.0));
		System.out.println(Test.addEdge(10, 11, 2.0));
		System.out.println(Test.addEdge(10, 12, 2.0));
		System.out.println(Test.addEdge(9, 13, 2.0));
		System.out.println(Test.addEdge(9, 8, 2.0));
		System.out.println(Test.addEdge(2, 9, 2.0));

		System.out.println(Test.getWeight(8, 3));

		System.out.println(Test.removeNode(8));
		System.out.println(Test.removeEdge(6, 7));

		System.out.println(Test.getWeight(3, 8));
		System.out.println(Test.numEdges());

		System.out.println(Test.setWeight(10, 1, 4.0));
		System.out.println(Test.setWeight(10, 11, 4.0));
		System.out.println(Test.getWeight(10, 11));
		System.out.println(Test.numNodes());

		Iterator iter = Test.breadthFirstIterator();

		while (iter.hasNext()) {
			int init = (int) ((Test.Node) iter.next()).element;
		}
		Iterator iter2 = Test.depthFirstIterator();

		while (iter2.hasNext()) {
			int init = (int) ((Test.Node) iter2.next()).element;
		}
