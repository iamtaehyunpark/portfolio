...
public class UseStudent3 {
	...
	public static void main(String[] args) {
	    ...
	    StudentBody sb = new StudentBody(theStudents);
	    ...
	    sb.setOrdering(Student.order_Gpa_Within_Major);

	    sb.sort();

	    sb.printStudents();

	    sb.setOrdering(Student.order_Gpa_Within_ClassOf);

	    sb.sort();

	    sb.printStudents();

	    sb.setOrdering(Student.order_Major_Within_ClassOf);
