...
public class UseStudent2 {
	...
	public static void main(String[] args) {
	    ...
	    System.out.println("Sorted by " + theStudents[0].getOrdering());
	    
	    for (int i = 0; i < theStudents.length; i++) {
		System.out.println(theStudents[i]);
	    }

	    // Set new sort Gpa Winthin ClsssOf
	    for (int i = 0; i < theStudents.length; i++) {
		theStudents[i].setOrdering(Student.order_Gpa_Within_ClassOf);
	    }
	    ...
	    // Set new sort Major Winthin ClsssOf
	    for (int i = 0; i < theStudents.length; i++) {
		theStudents[i].setOrdering(Student.order_Major_Within_ClassOf);
	    }
